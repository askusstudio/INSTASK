...
export function InstagramMockup({
  ...
  return (
    <div className="w-full max-w-[340px] sm:max-w-[360px] mx-auto bg-black rounded-[40px] p-3 shadow-2xl border-4 border-slate-800 text-slate-900 font-sans">
      ...
      <div className="bg-white rounded-[32px] overflow-hidden flex flex-col">
        ...
        >
          ...
          <div className="absolute top-2.5 right-2.5 bg-black/70 backdrop-blur-md px-2 py-0.5 rounded-full flex items-center gap-1 text-[9px] font-bold text-white tracking-wide border border-white/10">
        ...
        <div className="px-3.5 pt-2.5 pb-1">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="text-slate-900 hover:text-slate-600 transition">
          ...
          {/* Caption */}
          <div className="mt-1 text-xs text-slate-800 leading-snug max-h-28 overflow-y-auto pr-1">
