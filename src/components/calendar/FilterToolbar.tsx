...
export function FilterToolbar({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-6 shadow-soft space-y-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
          <button
            ...
            disabled={publishing}
            className="touch-target-48 sm:touch-target-auto inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200/80 transition"
          ...
          <button
            ...
            className="touch-target-48 sm:touch-target-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs sm:text-sm font-extrabold text-white bg-gradient-to-r from-rose-500 via-pink-600 to-purple-600 hover:opacity-95 shadow-soft transition disabled:opacity-50"
          >
      ...
      {/* Filter Tabs & Horizontal Momentum Scrolling */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2">
        {/* Category Pills: Smooth Horizontal Touch Momentum Scroll */}
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar scroll-smooth py-1 -mx-1 px-1 sm:flex-wrap">
          {THEMES.map((theme) => {
            ...
            return (
              <button
                ...
                className={`touch-target-48 sm:touch-target-auto px-4 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap transition flex-shrink-0 ${
                  isSelected
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          ...
          <select
            ...
            className="touch-target-48 sm:touch-target-auto text-xs font-semibold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-rose-500"
          >
